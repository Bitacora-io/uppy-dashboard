...
module.exports = (_temp = (_openFileEditorWhenFilesAdded = /*#__PURE__*/_classPrivateFieldLooseKey("openFileEditorWhenFilesAdded"), _attachRenderFunctionToTarget = /*#__PURE__*/_classPrivateFieldLooseKey("attachRenderFunctionToTarget"), _isTargetSupported = /*#__PURE__*/_classPrivateFieldLooseKey("isTargetSupported"), _getAcquirers = /*#__PURE__*/_classPrivateFieldLooseKey("getAcquirers"), _getProgressIndicators = /*#__PURE__*/_classPrivateFieldLooseKey("getProgressIndicators"), _getEditors = /*#__PURE__*/_classPrivateFieldLooseKey("getEditors"), _class = /*#__PURE__*/function (_UIPlugin) {
  _inheritsLoose(Dashboard, _UIPlugin);

  function Dashboard(uppy, _opts) {
    var _this;

    _this = _UIPlugin.call(this, uppy, _opts) || this;
    ...
    _this.handlePaste = function (event) {
      ...
      if (files.length > 0) {
        _this.uppy.log('[Dashboard] Files pasted');
    ...
    _this.handleInputChange = function (event) {
      ...
      if (files.length > 0) {
        _this.uppy.log('[Dashboard] Files selected through input');
    ...
    _this.handleDragOver = function (event) {
      ...
      var canSomePluginHandleRootDrop = function canSomePluginHandleRootDrop() {
        var somePluginCanHandleRootDrop = true;
      ...
      var doesEventHaveFiles = function doesEventHaveFiles() {
      ...
      var somePluginCanHandleRootDrop = canSomePluginHandleRootDrop(event);
      var hasFiles = doesEventHaveFiles(event);

      if (!somePluginCanHandleRootDrop && !hasFiles || _this.opts.disabled // opts.disableLocalFiles should only be taken into account if no plugins
      // can handle the datatransfer
      || _this.opts.disableLocalFiles && (hasFiles || !somePluginCanHandleRootDrop) || !_this.uppy.getState().allowNewUpload) {
      ...
      _this.opts.onDragOver == null ? void 0 : _this.opts.onDragOver(event);
    };
    ...
    _this.handleDragLeave = function (event) {
      ...
      _this.opts.onDragLeave == null ? void 0 : _this.opts.onDragLeave(event);
    };

    _this.handleDrop = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
        var executedDropErrorOnce, logDropError, files;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                executedDropErrorOnce = false;

                logDropError = function logDropError(error) {
                  _this.uppy.log(error, 'error'); // In practice all drop errors are most likely the same,
                ...
                _context.next = 9;
                return getDroppedFiles(event.dataTransfer, {
              ...
              case 9:
                ...
                if (files.length > 0) {
                  _this.uppy.log('[Dashboard] Files dropped');

                  _this.addFiles(files);
                }

                _this.opts.onDrop == null ? void 0 : _this.opts.onDrop(event);
    ...
    _this.handleComplete = function (_ref2) {
    ...
    _this.render = function (state) {
      ...
      if (['files', 'folders', 'both'].indexOf(_this.opts.fileManagerSelectionType) < 0) {
        ...
        console.warn("Unsupported option for \"fileManagerSelectionType\". Using default of \"" + _this.opts.fileManagerSelectionType + "\".");
      }
    ...
    _this.modalName = "uppy-Dashboard-" + nanoid();
    _this.defaultLocale = locale; // set default options
  ...
  return Dashboard;
}(UIPlugin)), _class.VERSION = "2.1.3", _temp);